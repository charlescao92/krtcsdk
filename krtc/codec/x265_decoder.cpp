...
namespace krtc {
    ...
    H265DecoderImpl::H265DecoderImpl(const cricket::VideoCodec& codec)
        : ffmpeg_buffer_pool_(true),
        decoded_image_callback_(nullptr),
        has_reported_init_(false),
        has_reported_error_(false),
        preferred_output_format_(webrtc::field_trial::IsEnabled("WebRTC-NV12Decode")
    ...
    int32_t H265DecoderImpl::Decode(const webrtc::EncodedImage& input_image,
        bool /*missing_frames*/,
        ...
        int64_t frame_timestamp_us = input_image.ntp_time_ms_ * 1000;  // ms -> ¦Ìs
        ...
        if (preferred_output_format_ == webrtc::VideoFrameBuffer::Type::kNV12) {
            const webrtc::I420BufferInterface* cropped_i420 = cropped_buffer->GetI420();
       ...
       /* const webrtc::ColorSpace& color_space =
            ...
            : webrtc::ExtractH265ColorSpace(av_context_.get());*/
